...
ST.put(ID, type, "function", scope);
  ...
  // Set new scope here for function.
    ...
    statement_block();
ASTReturnValue jjtn001 = new ASTReturnValue(JJTRETURNVALUE);
       boolean jjtc001 = true;
       jjtree.openNodeScope(jjtn001);
    try {
      function_return();
 ...
 */
  static final public void simple_expression() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LBRACE:{
      jj_consume_token(LBRACE);
      expression();
...
*/
  ...
  static final public void compare() throws ParseException {/*@bgen(jjtree) Compare */
...
// Similar to simple_expression, but without the <LBRACE> choice conflict.
  static final public void simple_special_expression() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ID:{
      t = jj_consume_token(ID);
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
if (jjtc000) {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x3000000,0x38000000,0x3000000,0x3000000,0x38000000,0x3000000,0x4800,0x0,0x80,0x80000000,0xc00,0x80000000,0x4000,0x6000,0x6000,0x800,0x4800,0xc800,0x30000,0x30000,0x4800,0xfc0000,0xfc0000,0x6000,0x6000,0x800,0x4000,0x0,0x80,0x38000000,0x3000000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x306,0x200,0x0,0x299,0x0,0x299,0x106,0x0,0x0,0x0,0x306,0x306,0x0,0x0,0x306,0x0,0x0,0x0,0x0,0x0,0x306,0x200,0x0,0x0,0x0,};
	}
